---
description: Integrate verified parallel plan branches into main: sequential merge, conflicts, full suite, plan cleanup.
agent: builder
---
...
5. Cleanup: delete the integrated plan files, report what landed in what order.
