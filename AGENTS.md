...
Agents: 7 (builder, planner = primary; designer, tester, reviewer, documenter, integrator = subagents). See `agents/*.md`. Workflow: builder delegates complex multi-step work to planner (Task call) → planner returns plan → builder executes.
